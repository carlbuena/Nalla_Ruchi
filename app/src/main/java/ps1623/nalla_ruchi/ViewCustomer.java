...
public class ViewCustomer extends BaseActivity implements View.OnClickListener {
    ...
    private void getCustomer(){
        class GetCustomer extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ViewCustomer.this,"Fetching...","Wait...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam(Config.URL_GET_CUSTOMER,customerid);
                return s;
            }
        }
    ...
    private void updateCustomer(){
        ...
        class UpdateCustomer extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ViewCustomer.this,"Updating...","Wait...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                loading.dismiss();
                Toast.makeText(ViewCustomer.this,s,Toast.LENGTH_LONG).show();
            }
        ...
        alertDialogBuilder.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        deleteCustomer();
                        startActivity(new Intent(ViewCustomer.this,ViewAllCustomers.class));
                    }
                });
